...
public class Surround extends Module {
    ...
    public Setting jumpDisable;
    public Setting autoToggle;
    public Setting chainPopToggle;
    Setting hidden;

    @Override
    public void setup(){
        rSetting(jumpDisable = new Setting("Toggle on Jump", this, true, ""));
        rSetting(autoToggle = new Setting("Toggles", this, false, ""));
        rSetting(chainPopToggle = new Setting("TotemPopToggle", this, true, ""));
    ...
    public void onUpdate() {
        ...
        if (!mc.player.onGround && jumpDisable.getBVal()) {
            toggle();
            return;
        }
        ...
        if ((autoToggle.getBVal() || chainPopToggle.getBVal()) && (mc.world.getBlockState(new BlockPos(vec3d).north()).getBlock() == Blocks.OBSIDIAN || mc.world.getBlockState(new BlockPos(vec3d).north()).getBlock() == Blocks.BEDROCK) && (mc.world.getBlockState(new BlockPos(vec3d).south()).getBlock() == Blocks.OBSIDIAN || mc.world.getBlockState(new BlockPos(vec3d).south()).getBlock() == Blocks.BEDROCK) && (mc.world.getBlockState(new BlockPos(vec3d).west()).getBlock() == Blocks.OBSIDIAN || mc.world.getBlockState(new BlockPos(vec3d).west()).getBlock() == Blocks.BEDROCK) && (mc.world.getBlockState(new BlockPos(vec3d).east()).getBlock() == Blocks.OBSIDIAN || mc.world.getBlockState(new BlockPos(vec3d).east()).getBlock() == Blocks.BEDROCK)) {
            chainPopToggle.setValBoolean(false);
            toggle();
        }
    }
