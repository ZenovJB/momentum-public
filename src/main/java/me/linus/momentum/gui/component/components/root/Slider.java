...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Render.drawRectStatic(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, this.hovered ? new Colors(56, 56, 56, gui.getAlpha()) : new Colors(36, 36, 36, gui.getAlpha()));
		 final int drag = (int)(this.set.getDVal() / this.set.getMax() * this.parent.parent.getWidth());
		Render.drawRectStatic(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12, hovered ? new Colors(gui.getRed(), gui.getGreen(), gui.getBlue(), gui.getAlpha()) : new Colors(68, 68, 68, gui.getAlpha()));
		FontUtils.drawStringWithShadow(gui.cfont.getBVal(), this.set.getDisplayName() + ": " + this.set.getDVal() , (parent.parent.getX() + 4), (parent.parent.getY() + offset + 2), new Colors(255, 255, 255));
	}
	...
	public void updateComponent(int mouseX, int mouseY) {
		...
		renderWidth = (126) * (set.getDVal() - min) / (max - min);
