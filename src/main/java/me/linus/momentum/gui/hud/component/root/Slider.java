...
public class Slider extends Component {
    ...
    public void renderComponent() {
        ...
        Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, this.hovered ? new Color(56, 56, 56).getRGB() : new Color(36, 36, 36).getRGB());
        final int drag = (int)(this.set.getDVal() / this.set.getMax() * this.parent.parent.getWidth());
        Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12,hovered ? new Color(gui.getRed(), gui.getGreen(), gui.getBlue()).getRGB() : 0xFF444444);
    ...
    public void mouseReleased(int mouseX, int mouseY, int mouseButton) {
        dragging = false; Momentum.configManager.SaveAll();
    }
