...
public class HUDButton extends Component {
    ...
    public HUDButton(Module mod, Frame parent, int offset) {
        this.mod = mod;
        this.parent = parent;
        this.offset = offset;
    ...
    public void renderComponent() {
        ...
        Gui.drawRect(parent.getX(), this.parent.getY() + this.offset, parent.getX() + parent.getWidth(), this.parent.getY() + 12 + this.offset, this.isHovered ? (this.mod.isToggled() ? new Color(gui.getRed(), gui.getGreen(), gui.getBlue()).getRGB() : 0xFF222222) : (this.mod.isToggled() ? new Color(gui.getRed(), gui.getGreen(), gui.getBlue()).getRGB() : 0xFF111111));
        ...
        if (this.rootcomponents.size() > 2)
            FontUtils.drawStringWithShadow(gui.cfont.getBVal(), this.open ? "-" : "+", (parent.getX() + parent.getWidth() - 8) , this.parent.getY() + this.offset + 2, new Colors(255, 255, 255));
